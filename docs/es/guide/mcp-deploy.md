...
| Las llamadas agotan el tiempo límite | La herramienta es lenta (a menudo un agente) | `limits` del agente más pequeños; aumenta el tiempo límite del cliente (Claude Code: `MCP_TOOL_TIMEOUT`). |
