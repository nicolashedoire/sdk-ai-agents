...
| `npm install @sdk-ai-agents/core …` | Instala este SDK, zod (para describir los argumentos) y el SDK oficial de MCP, versión 1.30 o posterior dentro de la 1.x (la versión con la que se prueba este SDK). |
