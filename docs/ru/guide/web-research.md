...
- **Кеши и интервалы между запросами живут в памяти**, отдельно для каждого вызова `webTools()`, и теряются, когда процесс завершается.
