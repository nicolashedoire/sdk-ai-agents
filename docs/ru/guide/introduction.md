...
- **Исследования** — исследователь, который понимает объект, затем предлагает, как перепроектировать его современными средствами: семь этапов, утверждения, проверяемые по источникам, в которых он действительно искал, и замороженный устав со стражем, который удерживает его на цели. См. [Исследования](./studies).
