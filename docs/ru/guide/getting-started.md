...
Требования: **Node.js 20+**, TypeScript 5+ и **zod 3.25.28 или новее в пределах v3** — схемы zod 4 пока не поддерживаются. Коннекторам MCP дополнительно нужен официальный MCP SDK:
