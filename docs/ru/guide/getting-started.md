...
Установите пакет из npm вместе с zod:
...
Чтобы попробовать ещё не выпущенные изменения, установите вместо этого ветку `main` с GitHub — она собирается сама при установке:
