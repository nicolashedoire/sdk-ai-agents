...
| `npm install @sdk-ai-agents/core …` | Устанавливает этот SDK, zod (для описания аргументов) и официальный MCP SDK версии 1.30 или новее в пределах 1.x (версия, с которой тестируется этот SDK). |
