...
- تستخدم Vitest
- محاكاة التبعيات الخارجية (mocking: مزوّدو النماذج اللغوية، ومخازن الأحداث)

### اختبارات التكامل {#integration-tests}

- اختبارات تكامل لسير العمل الكامل
- تستخدم بدائل محاكاة (mocks) لمزوّدي النماذج اللغوية
...
1. تحقّق من أن بدائل المحاكاة (mocks) صحيحة
