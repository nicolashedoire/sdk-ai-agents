...
::: tip بكلمات بسيطة
الإصدار ثلاث خطوات: تدوين رقم النسخة الجديد وما تغيّر، ودمج هذا التغيير، ثم دفع وسم يحمل اسم النسخة. يعيد GitHub تشغيل الفحوص وينشر الحزمة على npm، ومعها إفادة موقّعة تذكر أي إيداع (commit) وأي سير عمل بنياها.
:::
