...
يُكتَب كل قرار مُنمَّط حدثًا من نوع `decision.evaluated` مع سياقه، وأسئلته، وإجاباته، واستهلاكه للرموز — في `runId` الذي تمرّره، أو في مسار مخصّص `decision_*`. سعر Jev هو **0.042 دولار لكل مليون رمز مُدخَل، والمُخرَجات مجانية** (كما هو موثّق في 2026-09-23)، لذا يتضمّنه `sdk.getRunCost(runId)` مباشرةً دون إعداد. ويُحتسَب كل قرار أيضًا في الميزانيات لكل فترة — لـ `agentId` الذي يسمّيه، وفي الحدود التي لا تسمّي وكيلًا — ولا ترفضه أي ميزانية أبدًا (انظر [تكاليف API](./costs#budgets)).
