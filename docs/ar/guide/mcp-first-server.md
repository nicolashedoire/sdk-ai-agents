...
| `npm install @sdk-ai-agents/core …` | يثبّت حزمة SDK هذه، وzod (لوصف المعاملات)، وحزمة MCP SDK الرسمية، الإصدار 1.30 أو أحدث ضمن 1.x (الإصدار الذي اختُبرت عليه حزمة SDK هذه). |
