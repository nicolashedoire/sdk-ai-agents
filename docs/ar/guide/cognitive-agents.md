...
- يعيد `sdk.replay(runId)` تنفيذ استدعاءات أدواته دون استدعاء النموذج اللغوي ويعيد إنتاج الإجابة النهائية — مع قيد الأدوات نفسه الذي كان في التشغيل الأصلي، فالأداة التي رُفضت للوكيل تُرفَض مرة أخرى؛
