...
| `duckDuckGo({ region?, minIntervalMs?, baseUrl? })` | `SearchProvider` | Le fournisseur par défaut de `web_search`, sans clé : la page HTML de DuckDuckGo, 4 s entre deux recherches, comptées à partir de la fin de la précédente |
