...
| `normalizeUrl(url)` | `string \| undefined` | वह URL जिससे किसी खोज परिणाम को पहचाना जाता है: tracking पैरामीटर, fragment और आख़िर का slash हटाकर; http(s) के अलावा किसी भी चीज़ के लिए `undefined` |
