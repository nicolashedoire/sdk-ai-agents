...
| `providerConfig` | `{ openai?, anthropic? }` | हर प्रदाता की सेटिंग्स: `apiKey`, `defaultModel` और `baseURL` (कोई संगत endpoint, जैसे Azure OpenAI की v1 API या लोकल मॉडल सर्वर, या कोई proxy)। मुख्य प्रदाता और उसी vendor के फ़ॉलबैक इन्हें इस्तेमाल करते हैं |
| `fallbackProviders` | `Array<{ provider, config? }>` | मुख्य प्रदाता के विफल होने पर क्रम से आज़माए जाते हैं; `config`, उसके vendor के `providerConfig` से ऊपर होता है। किसी दूसरे vendor के फ़ॉलबैक को अपनी `apiKey` चाहिए |
