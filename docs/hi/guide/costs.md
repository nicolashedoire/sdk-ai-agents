...
लागत सिर्फ़ एक पहलू है; नीतियाँ हर एजेंट, टूल और अवधि के लिए **कदमों, tokens और टूल कॉल** की सीमा भी तय कर सकती हैं — देखें [नियंत्रित एजेंट](./governed-agents)। संज्ञानात्मक एजेंटों की अपनी सीमाएँ होती हैं (`maxSteps`, `maxToolCalls`, `timeoutMs`)। `maxCost` वाला `budgetLimit`, ऊपर की कीमतों के हिसाब से, किसी एजेंट की मॉडल कॉल का हर अवधि का USD खर्च सीमित करता है; अगर किसी मॉडल की कीमत नहीं है, तो सीमा जाँची नहीं जा सकती और टूल कॉल ठुकरा दी जाती हैं।
