...
लागत सिर्फ़ एक पहलू है; नीतियाँ हर एजेंट, टूल और अवधि के लिए **कदमों, tokens और टूल कॉल** की सीमा भी तय कर सकती हैं — देखें [नियंत्रित एजेंट](./governed-agents)। संज्ञानात्मक एजेंटों की अपनी सीमाएँ होती हैं (`maxSteps`, `maxToolCalls`, `timeoutMs`)।
