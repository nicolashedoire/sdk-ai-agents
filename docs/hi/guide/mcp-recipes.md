...
- **इसमें समय लगता है।** एक संज्ञानात्मक run मॉडल की कई कॉल करता है: दसियों सेकंड मानकर चलें, कभी-कभी मिनट। कई क्लाइंट लगभग एक मिनट बाद कॉल रद्द कर देते हैं (आधिकारिक TypeScript SDK का डिफ़ॉल्ट 60 सेकंड है; Claude Code इसे `MCP_TOOL_TIMEOUT` से बढ़ाने देता है)। इंटरैक्टिव उपयोग के लिए `limits` छोटे रखें। **जब क्लाइंट हार मान लेता है, तो run रोक दिया जाता है** (संज्ञानात्मक और नियंत्रित, दोनों एजेंटों में) और रद्द के रूप में दर्ज होता है: मॉडल की आगे कोई कॉल नहीं होती, और जिस मंज़ूरी का एजेंट इंतज़ार कर रहा था वह रद्द हो जाती है।
