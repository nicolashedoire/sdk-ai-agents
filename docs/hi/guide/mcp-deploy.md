...
संदेश चरणों, टूल और संज्ञानात्मक ऑपरेशनों के नाम बताते हैं: मॉडल द्वारा चुना गया टूल, और एजेंट द्वारा कॉल किया गया हर टूल, एजेंट के वे टूल भी जिन्हें सर्वर उपलब्ध नहीं कराता। जो टूल अपने संदर्भ के `onEvent` के साथ कोई [अध्ययन](./studies) चलाता है, उसका वर्णन चरण के हिसाब से होता है (`study started`, `passage changes started`, `search in changes`), क्वेरी के हिसाब से कभी नहीं। संदेशों में कभी arguments, परिणाम या error के टेक्स्ट नहीं होते। कोई `total` नहीं है: किसी को पहले से पता नहीं होता कि एक run में कितने चरण लगेंगे। हर सूचना परिणाम से पहले भेजी जाती है, उसके बाद कभी नहीं। Streamable HTTP पर वे response की स्ट्रीम (SSE) पर जाती हैं; `enableJsonResponse: true` के साथ बनाया गया transport सादे JSON में जवाब देता है और उन्हें छोड़ देता है। जो क्लाइंट कोई `progressToken` नहीं भेजता, उसे कोई सूचना नहीं मिलती।
