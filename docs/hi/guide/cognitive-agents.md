...
- `sdk.replay(runId)` LLM को बुलाए बिना इसकी टूल कॉल दोबारा चलाता है और अंतिम उत्तर फिर से बनाता है — मूल run वाली टूल-पाबंदी के साथ, इसलिए जो टूल एजेंट के लिए मना था वह फिर से मना होता है;
