...
- **PDF** का टेक्स्ट वैकल्पिक पैकेज [`unpdf`](https://github.com/unjs/unpdf) (Node.js 22 या उसके बाद का) से पढ़ा जाता है: `npm install unpdf`। इसके बिना, `web_fetch` यही बताता है। शीर्षक और तारीख़ दस्तावेज़ से आते हैं। प्रोसेस में PDF एक-एक करके पढ़ी जाती हैं, हर एक अपने worker thread में। pdf.js के किसी PDF को पढ़ने से पहले, worker उसकी streams को उनके filters (Flate, LZW और RunLength, एक के बाद एक जुड़े हुए भी, और उन्हें लपेटने वाले ASCII85 और ASCIIHex) से गुज़ारकर decompress करता है, और कुल मिलाकर 256 MB से ज़्यादा होने पर PDF को ठुकरा देता है: इस माप को प्रोसेस के बाकी हिस्से से कुछ नहीं चाहिए, इसलिए गीगाबाइट्स तक फूल जाने वाली कोई छोटी PDF तब भी ठुकरा दी जाती है जब main thread व्यस्त हो। जिस stream को वह माप नहीं सकता (encrypted, या ऐसे filter वाली जिसे वह नहीं जानता, जैसे किसी image का), उसे pdf.js पर छोड़ दिया जाता है। दूसरी रक्षा-पंक्ति के रूप में, worker को रोक दिया जाता है अगर पढ़ते समय प्रोसेस 1 GB से ज़्यादा बढ़ जाए, 20 s के बाद, या जब कॉल खत्म हो; अपनी बारी का इंतज़ार भी कॉल की समय-सीमा में गिना जाता है।
