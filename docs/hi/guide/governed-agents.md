...
- `onText` के साथ, बिल्ट-इन OpenAI और Anthropic प्रदाता अपने विक्रेता की स्ट्रीमिंग API कॉल करते हैं, और run का नतीजा और इवेंट वैसे ही रहते हैं जैसे इसके बिना। उसकी लागत भी, सिवाय OpenAI-संगत सर्वर (एक `baseURL`) के: स्ट्रीम किए गए जवाब का उपयोग सिर्फ़ OpenAI की अपनी API पर माँगा जाता है, जब तक `providerConfig.openai.includeStreamUsage` सेट न हो, और बिना उपयोग वाली कॉल बजट में बिना माप वाली (unmetered) गिनी जाती है।
