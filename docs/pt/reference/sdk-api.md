...
| `normalizeUrl(url)` | `string \| undefined` | A URL pela qual um resultado de pesquisa é identificado: parâmetros de rastreamento, fragmento e barra final removidos; `undefined` para qualquer coisa que não seja http(s) |
