...
| `npm install @sdk-ai-agents/core …` | Instala este SDK, o zod (para descrever os argumentos) e o SDK oficial do MCP, versão 1.30 ou posterior dentro da 1.x (a versão com que este SDK é testado). |
