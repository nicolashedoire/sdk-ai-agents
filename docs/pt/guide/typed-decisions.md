...
| `retryBaseDelayMs` | `500` | Primeira espera, dobrada a cada nova tentativa |
| `maxRetryDelayMs` | `30000` | Limite de cada espera, incluindo `retry-after` |
