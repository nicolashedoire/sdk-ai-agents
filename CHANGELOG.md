...
- A `seek_information` step that brings no observation counts as a failed attempt: after two in a row, the operation waits for new evidence instead of spending the budget on tools that cannot answer.
