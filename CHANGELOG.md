...
### Documentation
- SDK API reference: the `retry` row says it is also the default of the Jev client's retries (`jev.maxRetries` and `jev.retryBaseDelayMs` override it), as the resilience guide already did.
